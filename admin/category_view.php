                                        ...
                                        <?php
                                            ...
                                            while($cat_row=mysqli_fetch_assoc($cat_res))
                                            {
                                                echo '<tr class="odd gradeX">
                                                          ...
                                                          <td align="center"><a style="color: red;" href="category_edit.php?id='.$cat_row['cat_id'].'">Edit</a> &nbsp;&nbsp;
                                                              <a style="color: red;"  href="process_category_del.php?id='.$cat_row['cat_id'].'">x</a></td>
                                                      </tr>';
                                                $count++;
                                            }
