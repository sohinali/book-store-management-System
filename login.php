...
<div id="content">
	<div class="post">
		<h2 class="title"><a href="#"  style="color:black;">Login</a></h2>
			<p class="meta"></p>
			<div class="entry">
			...
			?>
					...
					<p class="login_link">
						<a href="forget_password.php" style="  color:black; text-decoration: none">Forget Password ?</a>
						<a href="register.php" style="  color:black;margin-left: 100px;text-decoration: none">Register</a>
					</p>
